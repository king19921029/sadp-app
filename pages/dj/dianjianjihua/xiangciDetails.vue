<template>
	<view class="containersjb">
		...
		<scroll-view scroll-y="true" class="detail">
			...
			<view class="detail-list">
				<view>点检标准项次号:</view>
				<view>{{datas.xiangciid}}</view>
			</view>
			<view class="detail-list">
				<view>点检标准名称:</view>
				<view>{{datas.biaozhunname}}</view>
			</view>
			<view class="detail-list">
				<view>内容:</view>
				<view>{{datas.content}}</view>
			</view>
			<view class="detail-list">
				<view>计量单:</view>
				<view>{{datas.jiliangdan}}</view>
			</view>
			<view class="detail-list">
				<view>标准:</view>
				<view style="max-width: 364upx;">{{datas.biaozhun}}</view>
			</view>
			<view class="detail-list">
				<view>上限:</view>
				<view>{{datas.shangxian}}</view>
			</view>
			<view class="detail-list">
				<view>下限:</view>
				<view>{{datas.xiaxian}}</view>
			</view>
			<view class="detail-list">
				<view>本次结果:</view>
				<view>{{datas.bencijieguo}}</view>
			</view>
			<view class="detail-list">
				<view>判定:</view>
				<view>{{datas.panding}}</view>
			</view>
			<view class="detail-list">
				<view>点检方式:</view>
				<view>{{datas.dianjianmethod}}</view>
			</view>
			<view class="detail-list">
				<view>管理控别:</view>
				<view>{{datas.guanlikongbie}}</view>
			</view>
			<view class="detail-list">
				<view>管理类别:</view>
				<view>{{datas.guanlileibie}}</view>
			</view>
			<view class="detail-list">
				<view>数据类别:</view>
				<view>{{datas.datatype}}</view>
			</view>
		</scroll-view>
